...
//    @Inject private login loginBean;
...
//          	
//          		}
//                         else if((request.getRequestURI().contains("/verificationCenter/") && !request.getSession().getAttribute("logged-group").equals("verificationCenter")))
//         		 {
//               // response.sendError(HttpServletResponse.SC_UNAUTHORIZED, "You are Not Authorised to view this Page . Go Back To Login");
//                      request.getServletContext().getRequestDispatcher("/Unauthorised.jsf").forward(request, response);
//          	
...
//               loginBean.setGroups(result.getCallerGroups());
//                return status;
//            }
//            else
//            {
////                loginBean.setMessage("Login Error : Either Login or Password is Wrong. Try Again");
//                loginBean.setErrorMessage("Login Error : Either Login or Password is Wrong. Try Again");
